...
if (AntiLink) {
    ...
    Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
    } else {
    }
    }
...
if (antiVirtex) {
    ...
    if (AntiLink) {
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ YOUTUBE LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️! HAPA AKUNA MSANII⚠️❗`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ YOUTUBE CHANNEL LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ INSTAGRAM LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️! No promotion is allowed!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ FACEBOOK LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ TELEGRAM LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ TIKTOK LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
        ...
        kice = m.sender
        await Miku.groupParticipantsUpdate(m.chat, [kice], 'remove')
        Miku.sendMessage(from, {text:`\`\`\`「  Antilink System  」\`\`\`\n\n@${kice.split("@")[0]} *[ TWITTER LINK DETECTED ]* removed order from kanambo i take orders master🥷🏻🙋🏿‍♂️!`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
        } else {
        }
...
await sleep(500)
m.copyNForward(m.chat, true, { readViewOnce: true }).catch(_ => reply(`SORRY kanambo ordered to be opened by a bot`))
}
...
const ftroli = {
  ...
  const jumlahUser = pendaftar.length
    ...
    const menulist = `
    Hello ${pushname} dear 👋. I am ${global.BotName}, a bot developed by: 🍫⃞⃕᭕𝑠𝑐𝑖𝑒𝑛𝑡𝑖𝑠𝑡༆𝑘𝑎𝑛𝑎𝑚𝑏𝑜⟫⚖️⃞᭄ to take your WhatsApp usage into next level.
    ...
    ©️ *${global.BotName}* All Rights Reserved by: *🍫⃞⃕᭕𝑠𝑐𝑖𝑒𝑛𝑡𝑖𝑠𝑡༆𝑘𝑎𝑛𝑎𝑚𝑏𝑜⟫⚖️⃞᭄*
    `
...
switch(command) {
    ...
    title:"Powered by 🍫⃞⃕᭕𝑠𝑐𝑖𝑒𝑛𝑡𝑖𝑠𝑡༆𝑘𝑎𝑛𝑎𝑚𝑏𝑜⟫⚖️⃞᭄",
    body: " ", 
...
case 'help': case 'h': case 'menu': case 'allmenu': case 'listmenu':{
 ...
 const helpmenu = `𝘏𝘦𝘭𝘭𝘰 *${pushname}* 𝘩𝘰𝘱𝘦 𝘺𝘰𝘶 𝘨𝘰𝘰𝘥,

I am *kanambo bot*, a bot developed by *🍫⃞⃕᭕𝑠𝑐𝑖𝑒𝑛𝑡𝑖𝑠𝑡༆𝑘𝑎𝑛𝑎𝑚𝑏𝑜⟫⚖️⃞᭄*.
...
🍁 Then type " *${prefix}nsfwmenu* " to get full list of NSFW commands.
 ...
 『  *${global.BotName}*  』
 Powered by: *🍫⃞⃕᭕𝑠𝑐𝑖𝑒𝑛𝑡𝑖𝑠𝑡༆𝑘𝑎𝑛𝑎𝑚𝑏𝑜⟫⚖️⃞᭄*
